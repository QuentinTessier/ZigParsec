...
const ZigParsecState = @import("../Parser.zig").ZigParsecState;
...
pub fn myCombinator(stream: Stream, allocator: std.mem.Allocator, state: *ZigParsecState, comptime Value: type, p: anytype) anyerror!Result(Value) {
