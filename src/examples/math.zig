...
pub fn singleDigitNumger(stream: Parser.Stream, allocator: std.mem.Allocator, state: *u32) anyerror!Parser.Result(i32) {
...
pub fn subExpr(stream: Parser.Stream, allocator: std.mem.Allocator, state: *u32) anyerror!Parser.Result(i32) {
...
pub fn expr(stream: Parser.Stream, allocator: std.mem.Allocator, state: *u32) anyerror!Parser.Result(i32) {
...
pub fn term(stream: Parser.Stream, allocator: std.mem.Allocator, state: *u32) anyerror!Parser.Result(i32) {
    return Parser.Combinator.chainl1(
        stream,
        allocator,
        state,
...
pub fn factor(stream: Parser.Stream, allocator: std.mem.Allocator, state: *u32) anyerror!Parser.Result(i32) {
...
pub fn mulOp(stream: Parser.Stream, allocator: std.mem.Allocator, state: *u32) anyerror!Parser.Result(*const fn (std.mem.Allocator, i32, i32) anyerror!i32) {
...
pub fn addOp(stream: Parser.Stream, allocator: std.mem.Allocator, state: *u32) anyerror!Parser.Result(*const fn (std.mem.Allocator, i32, i32) anyerror!i32) {
    switch (try Parser.Combinator.choice(stream, allocator, state, u8, &.{
        .{ .parser = Parser.Char.symbol, .args = .{'+'} },
        .{ .parser = Parser.Char.symbol, .args = .{'-'} },
    })) {
