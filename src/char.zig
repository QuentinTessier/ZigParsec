...
pub fn Char(comptime I: type, comptime E: type) type {
    return struct {
        ...
        pub fn Any() Parser.ParserFn(I, std.meta.Child(I), E) {
            return struct {
        ...
        pub fn Range(comptime Values: anytype) Parser.ParserFn(I, @TypeOf(Values[0]), E) {
